...
public final class ALIQUAM_FLOO extends Charms
{
   ...
   public ALIQUAM_FLOO ()
   {
      ...
      text = "Aliquam Floo will register a fireplace with the Floo Network. "
            + "Place a sign above a fire with the unique effectType of the fireplace and cast this spell at the fire. "
            ...
            + "Toss the powder into a registered fireplace, walk into the fire, and say the effectType of your destination.";
